...
impl<T: core::cmp::PartialEq> core::cmp::PartialEq for Instance<T> {
    #[inline]
...
impl<T: core::cmp::Eq> core::cmp::Eq for Instance<T> {}
...
impl<T: core::cmp::PartialOrd> core::cmp::PartialOrd for Instance<T> {
    #[inline]
...
impl<T: core::cmp::Ord> core::cmp::Ord for Instance<T> {
    #[inline]
